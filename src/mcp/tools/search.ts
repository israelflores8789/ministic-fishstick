...
export const SearchToolInputSchema = z.object({
	...
	directoryPrefix: z.string().optional().describe("Optional relative directory path to restrict search (e.g. 'src/components')"),
	workspacePath: z.string().optional().describe("Workspace folder path (defaults to current process directory)"),
})
