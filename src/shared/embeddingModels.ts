...
export const EMBEDDING_MODEL_PROFILES: EmbeddingModelProfiles = {
  ...
  ollama: {
    ...
    'qwen3-embedding:0.6b': { dimension: 1024, scoreThreshold: 0.4 },
    'qwen3-embedding:4b': { dimension: 2560, scoreThreshold: 0.4 },
    'qwen3-embedding:8b': { dimension: 4096, scoreThreshold: 0.4 },
  },
  'openai-compatible': {
    'text-embedding-3-small': { dimension: 1536, scoreThreshold: 0.4 },
    'text-embedding-3-large': { dimension: 3072, scoreThreshold: 0.4 },
  ...
  gemini: {
    ...
    // text-embedding-004 REMOVED — EOL as of 2026-01-14, migrate to gemini-embedding-001
  },
  mistral: {
    'mistral-embed': { dimension: 1024, scoreThreshold: 0.4 },
  ...
  bedrock: {
    ...
    'amazon.nova-2-multimodal-embeddings-v1:0': { dimension: 3072, scoreThreshold: 0.4 },
